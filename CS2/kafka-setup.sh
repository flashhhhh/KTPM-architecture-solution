...
bin/kafka-console-consumer.sh --bootstrap-server localhost:9092 --topic unzip-topic --from-beginning --partition 0
...
bin/kafka-console-consumer.sh --bootstrap-server localhost:9092 --topic ocr-topic --group ocr-group